...
/* Private variables ---------------------------------------------------------*/
/* Definitions for ReadGyroTask */
osThreadId_t ReadGyroTaskHandle;
const osThreadAttr_t ReadGyroTask_attributes = {
  .name = "ReadGyroTask",
  .stack_size = 256 * 4,
...
/* USER CODE BEGIN Header_ReadGyroTask_Handler */
/**
  * @brief  Function implementing the ReadGyroTask thread.
...
/* USER CODE BEGIN Header_LCDTask_Handler */
/**
